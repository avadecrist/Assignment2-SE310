...
=======
    ...
    public void addProduct(String id, String name, String description, String size, String category, Double price, Temperature temperature, storeId storeId, aisleId aisleId, shelfId shelfId) {
